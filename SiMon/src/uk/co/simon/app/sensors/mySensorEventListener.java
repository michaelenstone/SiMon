...
public class mySensorEventListener implements SensorEventListener {
	...
	public final int TIME_CONSTANT = 30;
	...
	private void getRotationVectorFromGyro(float[] gyroValues, float[] deltaRotationVector, float timeFactor){
		...
		(float) android.util.FloatMath.sqrt(gyroValues[0] * gyroValues[0] +
		...
		float sinThetaOverTwo = (float)android.util.FloatMath.sin(thetaOverTwo);
		float cosThetaOverTwo = (float)android.util.FloatMath.cos(thetaOverTwo);
    ...
    private float[] getRotationMatrixFromOrientation(float[] o) {
        ...
        float sinX = (float)android.util.FloatMath.sin(o[1]);
        float cosX = (float)android.util.FloatMath.cos(o[1]);
        float sinY = (float)android.util.FloatMath.sin(o[2]);
        float cosY = (float)android.util.FloatMath.cos(o[2]);
        float sinZ = (float)android.util.FloatMath.sin(o[0]);
        float cosZ = (float)android.util.FloatMath.cos(o[0]);
	...
	public void setGyroOrientation(float[] gyroOrientation) {
	...
	public void setAccMagOrientation(float[] accMagOrientation) {

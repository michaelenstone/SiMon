...
public class ActivityReports extends FragmentActivity {
    ...
    public void onClickReports(View view) {
    	...
    	case R.id.newReportButton:
    		...
    		alertDialogBuilder.setTitle("New Report");

    		// set dialog message
    		alertDialogBuilder
    		.setMessage("Select Report to Create")
    		.setCancelable(true)
    		.setPositiveButton("Progress Report",new DialogInterface.OnClickListener() {
    		...
    		.setNegativeButton("Site Visit Report",new DialogInterface.OnClickListener() {
    			public void onClick(DialogInterface dialog,int id) {
    		    	Intent newProgressReport = new Intent(getBaseContext(), ActivityReport.class);
    ...
    public boolean onContextItemSelected(MenuItem item) {
    	...
    	case 1:
    		...
    		.setPositiveButton("Delete",new DialogInterface.OnClickListener() {
    			public void onClick(DialogInterface dialog,int id) {
    	    		...
    	    		datasource.open();
    	    		datasource.deleteReport(thisReport, true);
    	    		datasource.close();
    	    		PopulateList();
    		    	dialog.dismiss();
    			}
    	...
    	case 2:
    		...
    		if (thisReport.getReportType()){
    			reportRef=thisReport.getReportRef().replaceFirst("/SVR/", "/PR/");
    		} else {
    			reportRef=thisReport.getReportRef().replaceFirst("/PR/", "/SVR/");
    		}
    	...
    	case 3:
    		...
    		uploadProgress.setTitle("Upload");
    	...
    	case 4:
    		if (thisReport.hasPDF()) {
    			...
    			progress.setTitle("PDFCreator");
    			progress.setMessage("Creating PDF");
    			progress.setCancelable(false);
    			progress.show();    			
    			File oldPDF = new File(thisReport.getPDF());
    			if (!oldPDF.delete()){
    				Toast toast = Toast.makeText(this, "Old PDF Could not be delete", Toast.LENGTH_SHORT);
    				toast.show();
    			}
